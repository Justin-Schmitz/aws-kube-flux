...
RUN apk update \
 &&  apk add ca-certificates curl py-pip openssh-client \
 ...
 &&  curl --silent -L https://github.com/fluxcd/flux/releases/download/1.24.3/fluxctl_linux_amd64 -o /usr/local/bin/fluxctl \
